...
import threading
from slide_slicer import SlideExtractor  # Import your SlideExtractor class from slide_slicer.py
...
class SlideExtractorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("YouTube Slide Slicer - Created by Riyaz Abdul")
    ...
    def create_widgets(self):
        ...
        # Generate PDF Button
        self.pdf_button = Button(self.center_frame, text="Click here to Generate PDF", style="Accent.TButton", command=self.generate_pdf)
